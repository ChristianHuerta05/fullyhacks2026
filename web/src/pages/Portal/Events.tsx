...
const SCHEDULE: ScheduleDay[] = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        location: "CS 408",
        note: "See how Human Delta works end to end: crawl a website, upload PDFs and audio, and watch everything land in Memory. Then hit the API to run a semantic query, surface the right chunks, or open content by filesystem path. Learn how to wire both into your agent so it retrieves real sources instead of guessing.",
      },
      {
        time: "10PM-11PM",
        type: "workshop",
